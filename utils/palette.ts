...
export const normalizePalette = (palette: Palette, scale = 255): Palette => {
  return palette.map(color => color.map(x => x / scale));
};

/** Common palettes */
export const FIRE: Palette = [ [ 161, 0, 0 ], [ 234, 35, 0 ], [ 255, 129, 0 ], [ 242, 85, 0 ], [ 216, 0, 0 ] ];
export const BOAT: Palette = [ [ 62, 1, 35 ], [ 180, 0, 54 ], [ 237, 227, 222 ], [ 37, 121, 133 ], [ 13, 41, 58 ] ];
export const ICE: Palette = [ [ 41, 66, 123 ], [ 0, 32, 60 ], [ 56, 126, 187 ], [ 0, 59, 111 ], [ 40, 91, 135 ] ];
export const PURPLE_MAGIC: Palette = [ [ 41, 66, 123 ], [ 0, 32, 60 ], [ 128, 0, 128 ], [ 82, 25, 140 ], [ 64, 0, 64 ], [ 140, 25, 83 ] ];
export const FOREST: Palette = [ [ 35, 77, 32 ], [ 54, 128, 45 ], [ 0, 114, 76 ], [ 190, 209, 153 ], [ 41, 83, 69 ] ];
export const MUD: Palette = [ [ 137, 81, 81 ], [ 180, 122, 90 ], [ 150, 79, 48 ], [ 103, 65, 84 ], [ 107, 50, 50 ] ];
export const WATERMELON: Palette = [ [ 133, 48, 55 ], [ 255, 61, 78 ], [ 210, 95, 108 ], [ 20, 61, 29 ], [ 56, 122, 74 ] ];
export const SEA_FIRE: Palette = [ [ 0, 59, 111 ], [ 52, 115, 143 ], [ 18, 47, 61 ], [ 190, 62, 43 ], [ 237, 138, 69 ], [ 246, 222, 108 ] ];
export const RUBY: Palette = [ [ 133, 0, 20 ], [ 174, 0, 26 ], [ 225, 5, 49 ], [ 165, 7, 39 ], [ 107, 0, 21 ], [ 116, 23, 68 ], [ 130, 7, 60 ], [ 225, 60, 83 ] ];
export const CATERPILLAR: Palette = [ [ 176, 197, 153 ], [ 226, 217, 86 ], [ 130, 166, 32 ], [ 53, 136, 28 ], [ 3, 59, 12 ] ];
export const MAVERICK: Palette = [ [ 248, 10, 0 ], [ 253, 100, 0 ], [ 236, 198, 0 ], [ 36, 75, 28 ], [ 23, 34, 67 ] ];
export const OPAL: Palette = [ [ 237, 157, 189 ], [ 182, 141, 195 ], [ 170, 221, 241 ], [ 255, 246, 128 ], [ 255, 179, 108 ], [ 206, 251, 189 ] ];
export const AUTUMN: Palette = [ [ 215, 127, 40 ], [ 229, 203, 154 ], [ 221, 169, 96 ], [ 122, 40, 40 ], [ 206, 108, 49 ], [ 199, 60, 37 ] ];
export const WOOD: Palette = [ [ 242, 209, 181 ], [ 159, 52, 52 ], [ 51, 29, 29 ], [ 141, 112, 81 ], [ 225, 180, 134 ] ];
export const BLUE_MOON: Palette = [ [ 39, 40, 144 ], [ 95, 115, 186 ], [ 209, 219, 227 ], [ 253, 250, 196 ], [ 255, 220, 109 ] ];
export const MANDELBROT: Palette = [ [ 0, 7, 100 ], [ 32, 107, 203 ], [ 237, 255, 255 ], [ 255, 170, 0 ], [ 0, 2, 0 ], [ 0, 7, 0 ] ];
export const SIERRA: Palette = [ [ 59, 36, 38 ], [ 131, 100, 84 ], [ 125, 85, 51 ], [ 53, 35, 37 ], [ 187, 107, 51 ], [ 139, 115, 82 ], [ 252, 250, 223 ], [ 101, 44, 42 ], [ 126, 55, 43 ], [ 180, 114, 73 ], [ 224, 184, 126 ], [ 84, 109, 62 ], [ 71, 71, 46 ] ];
export const SKY: Palette = [ [ 208, 224, 229 ], [ 215, 229, 236 ], [ 211, 223, 234 ], [ 194, 215, 231 ], [ 165, 198, 227 ], [ 166, 203, 230 ], [ 173, 203, 229 ], [ 119, 131, 157 ] ];
