...
export const fasterLog10 = (number) => {
...
export const fasterSinh = (number) => {
...
export const fasterCosh = (number) => {
  return 0.5 * (fasterExp(number) + fasterExp(-number));
};
...
export const fasterTanh = (number) => {
