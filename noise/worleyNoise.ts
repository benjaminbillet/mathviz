...
export const makeWorleyNoise = (width: number, height: number, distance = euclidean2d, density = 0.1, nth = 0) => {
...
export const makeWorleyLogSumNoise = (width: number, height: number, distance = euclidean, density = 0.1, minDistance = 0.01) => {
  const buffer = new Float32Array(width * height * 4);
