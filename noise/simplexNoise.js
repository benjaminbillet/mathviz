...
export const makeSimplexNoiseFunction = (frequency = 32) => {
...
export const makeSimplexNoiseFunction2 = (preprocessFunc = null, postprocessFunc = null, gradients = DefaultGradients) => {
