...
import { complex, sin } from '../utils/complex';
...
const plotSinJulia = async (c, bailout, maxIterations, domain, suffix = '') => {
...
const plotAverageStripeSinJulia = async (c, bailout, maxIterations, stripeDensity, domain, suffix = '') => {
  const [ width, height ] = getPictureSize(size, domain);
