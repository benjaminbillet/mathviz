...
plotBitmapTrapJulia(`${__dirname}/ada.png`, 0.5, complex(-0.761, 0.15), 2, 100, JULIA_DOMAIN);
plotBitmapTrapJulia(`${__dirname}/ada.png`, 1, complex(-0.584, 0.488), 3, 100, JULIA_DOMAIN);
