...
const plotMandelbrot = async (d: number, bailout: number, maxIterations: number, domain: PlotDomain, suffix = '') => {
...
const plotContinuousMandelbrot = async (d: number, bailout: number, maxIterations: number, domain: PlotDomain, suffix = '') => {
  const [ width, height ] = getPictureSize(size, domain);
...
const plotAverageStripeMandelbrot = async (d: number, bailout: number, maxIterations: number, stripeDensity: number, domain: PlotDomain, suffix = '') => {
  const [ width, height ] = getPictureSize(size, domain);
...
const plotBitmapTrapMandelbrot = async (bitmapPath: string, trapSize: number, d: number, bailout: number, maxIterations: number, domain: PlotDomain, suffix = '') => {
