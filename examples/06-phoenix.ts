...
const plotPhoenix = async (c: ComplexNumber, p: ComplexNumber, d: number, bailout: number, maxIterations: number, domain: PlotDomain, suffix = '') => {
...
const plotContinuousPhoenix = async (c: ComplexNumber, p: ComplexNumber, d: number, bailout: number, maxIterations: number, domain: PlotDomain, suffix = '') => {
  const [ width, height ] = getPictureSize(size, domain);
...
const plotAverageStripePhoenix = async (c: ComplexNumber, p: ComplexNumber, d: number, bailout: number, maxIterations: number, stripeDensity: number, domain: PlotDomain, suffix = '') => {
  const [ width, height ] = getPictureSize(size, domain);
...
const plotBitmapTrapPhoenix = async (bitmapPath: string, trapSize: number, c: ComplexNumber, p: ComplexNumber, d: number, bailout: number, maxIterations: number, domain: PlotDomain, suffix = '') => {
