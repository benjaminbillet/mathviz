import {
  makeFernIfs,
  BARNSLEY_FERN_COEFFICIENTS,
  BARNSLEY_FERN_PROBABILITIES,
  BARNSLEY_FERN_DOMAIN,
  CYCLOSORUS_FERN_COEFFICIENTS,
  CULCITA_FERN_COEFFICIENTS,
  CULCITA_FERN_PROBABILITIES,
  CYCLOSORUS_FERN_PROBABILITIES,
  CULCITA_FERN_DOMAIN,
  CYCLOSORUS_FERN_DOMAIN,
} from '../ifs/barnsley-fern';
