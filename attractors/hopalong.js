...
export const makeChip = (a, b, c) => {
  return (z) => {
    ...
    const vv = v * v;
    return new Complex(z.im - Math.sign(z.re) * uu * vv, a - z.re);
  };
};
...
export const makeQuadrupTwo = (a, b, c) => {
  return (z) => {
    ...
    const vv = v * v;
    return new Complex(z.im - Math.sign(z.re) * u * vv, a - z.re);
  };
};
...
export const makeThreePly = (a, b, c) => {
  ...
  return (z) => new Complex(z.im - Math.sign(z.re) * Math.abs(Math.sin(z.re) * cosB + c - z.re * sinAbc), a - z.re);
};
