...
export const applyThreads = (input, width, height, density = 4, length = 4, period = 1, strideDistribution = DefaultStrideDistribution, behavior = ObedientBehavior) => {
...
export const applyThreads2 = (input, width, height, density = 4, length = 4, period = 1, strideDistribution = DefaultStrideDistribution, behavior = ObedientBehavior) => {
  const output = new Float32Array(input.length).fill(0);
