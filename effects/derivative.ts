...
export const applyDerivative = (input: PlotBuffer, width: number, height: number, distance = euclidean) => {
...
export const applySobelDerivative = (input: PlotBuffer, width: number, height: number, distance = euclidean): PlotBuffer => {
...
export const applyPrewittDerivative = (input: PlotBuffer, width: number, height: number, distance = euclidean): PlotBuffer => {
