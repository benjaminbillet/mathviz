...
export const refract = (input, displacement, width, height, intensity = 1, sampler = UpscaleSamplers.Bicubic) => {
...
export const refract2 = (input, displacementX, displacementY, width, height, intensity = 1, sampler = UpscaleSamplers.Bicubic) => {
  const output = new Float32Array(width * height * 4);
