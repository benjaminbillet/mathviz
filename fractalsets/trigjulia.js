import { sin, mul, modulus } from '../utils/complex';

export const makeTrigJulia = (c, trigFunc = sin, bailout = 50, maxIterations = 100) => {
  return (z0) => {
    let zn = z0;
    let iterations = 0;
...
export const makeStripeAverageTrigJuliaLinear = (c, trigFunc = sin, bailout = 50, maxIterations = 100, stripeDensity = 10) => {
